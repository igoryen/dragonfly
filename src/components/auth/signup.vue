        ...
        <div class="signup-form">
            <form @submit.prevent="onSubmit">
                ...
                <div class="input" :class="{invalid: $v.age.$error}">
                    ...
                    <p class="warn" v-if="!$v.age.minVal">You have to be at least {{ $v.age.$params.minVal.min }} years old</p>
                </div>
...
export default {
    ...
    validations: {
        ...
        confirmPassword: {
            // sameAs: sameAs('password') // data.password. Works.
            sameAs: sameAs(vm => {
                return vm.password
            })
        },
    ...
    methods: {
        ...
        onDeleteHobby(id) {
            this.hobbyInputs = this.hobbyInputs.filter(
                hobby => hobby.id !== id
            );
        },
        onSubmit() {
